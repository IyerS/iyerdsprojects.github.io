...
excerpt: "Our client, a grocery retailer, wants to utilise Machine Learning to reduce mailing costs, and improve ROI!"
---
...
<br>
![alt text](/assets/img/log-reg-confusion-matrix.png "Logistic Regression Confusion Matrix")
...
```
<br>
![alt text](/assets/img/log-reg-optimal-threshold-plot.png "Logistic Regression Optimal Threshold Plot")
...
<br>
![alt text](/assets/img/clf-tree-confusion-matrix.png "Decision Tree Confusion Matrix")
...
<br>
![alt text](/assets/img/clf-tree-nodes-plot.png "Decision Tree Max Depth Plot")
...
<br>
![alt text](/assets/img/clf-tree-max-depth-plot.png "Decision Tree Max Depth Plot")
...
<br>
![alt text](/assets/img/rf-confusion-matrix.png "Random Forest Confusion Matrix")
...
<br>
![alt text](/assets/img/rf-classification-feature-importance.png "Random Forest Feature Importance Plot")
<br>
<br>
![alt text](/assets/img/rf-classification-permutation-importance.png "Random Forest Permutation Importance Plot")
...
<br>
![alt text](/assets/img/knn-feature-selection-plot.png "KNN Feature Selection Plot")
...
<br>
![alt text](/assets/img/knn-confusion-matrix.png "KNN Confusion Matrix")
...
<br>
![alt text](/assets/img/knn-optimal-k-value-plot.png "KNN Optimal k Value Plot")
