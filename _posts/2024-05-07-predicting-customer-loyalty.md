...
image: "assets/img/regression-title-img.png"
tags: [Customer Loyalty, Machine Learning, Regression, Python]
excerpt: "Our client, a grocery retailer, hired a market research consultancy to append market level customer loyalty information to the database.  However, only around 50% of the client's customer base could be tagged, thus the other half did not have this information present.  Let's use ML to solve this!"
---
...
<br>
![alt text](/asstes/img/lin-reg-feature-selection-plot.png "Linear Regression Feature Selection Plot")
...
<br>
![alt text](/asstes/img/regression-tree-max-depth-plot.png "Decision Tree Max Depth Plot")
...
<br>
![alt text](/asstes/img/regression-tree-nodes-plot.png "Decision Tree Max Depth Plot")
...
<br>
![alt text](/asstes/img/rf-regression-feature-importance.png "Random Forest Feature Importance Plot")
<br>
<br>
![alt text](/asstes/img/rf-regression-permutation-importance.png "Random Forest Permutation Importance Plot")
